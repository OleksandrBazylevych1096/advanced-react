...
import {useAuthCallbackPage} from "./useAuthCallbackPage.ts";
...
describe("useAuthCallbackPage", () => {
    ...
    test("handles 2FA callback payload and navigates to 2FA page", async () => {
        ...
        renderHook(() => useAuthCallbackPage());
    ...
    test("returns invalid payload error when callback params are incomplete", async () => {
        const {result} = renderHook(() => useAuthCallbackPage());
