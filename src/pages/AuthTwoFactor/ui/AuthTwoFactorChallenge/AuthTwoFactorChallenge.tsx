...
import {methodKeyMap, otpLengthMap} from "../../config/consts.ts";

import styles from "./AuthTwoFactorChallenge.module.scss";
import {useAuthTwoFactorChallenge} from "./useAuthTwoFactorChallenge/useAuthTwoFactorChallenge.ts";
