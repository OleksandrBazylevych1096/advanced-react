...
import {useProductPageController} from "./useProductPageController";
...
describe("useProductPageController", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    ...
    test("loads product, breadcrumbs and syncs localized slug", () => {
        const {result} = renderHook(() => useProductPageController());
    ...
    test("uses skipToken when slug or locale is missing", () => {
        ...
        renderHook(() => useProductPageController());
