...
import type {FacetItemType, PriceRangeType, Product, ProductFacets, ProductImage, ProductsApiResponse} from "./model/types/Product";
...
export type {FacetItemType, Product, ProductCardProps, ProductFacets, ProductsApiResponse, PriceRangeType, ProductImage};
