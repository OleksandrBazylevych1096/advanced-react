...
export const useUserLocation = () => {
    ...
    useEffect(() => {
        ...
        const applyLocationSuccess = (position: GeolocationPosition): void => {
            setLocation([position.coords.latitude, position.coords.longitude]);
            setError(null);
            setLoading(false);
        };

        const applyLocationError = (err: GeolocationPositionError): void => {
        ...
        navigator.geolocation.getCurrentPosition(applyLocationSuccess, applyLocationError, {
