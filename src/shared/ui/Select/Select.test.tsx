...
describe("Select Component", () => {
    describe("Basic Rendering", () => {
        it("should render with placeholder", () => {
            render(
                <Select options={mockOptions} placeholder="Choose option" data-testid="select" />,
            );
        ...
        it("should render with default value", () => {
            render(<Select options={mockOptions} defaultValue="2" data-testid="select" />);
            expect(screen.getByTestId("select-value")).toHaveTextContent("Option 2");
        });

        it("should render with controlled value", () => {
            render(<Select options={mockOptions} value="3" data-testid="select" />);
        ...
        it("should render with different sizes", () => {
            const {rerender} = render(
                <Select options={mockOptions} size="xs" data-testid="select" />,
            );
        ...
        it("should render with different themes", () => {
            const {rerender} = render(
                <Select options={mockOptions} theme="outlined" data-testid="select" />,
            );
            expect(screen.getByTestId("select-control")).toHaveClass(/outlined/);

            rerender(<Select options={mockOptions} theme="filled" data-testid="select" />);
    ...
    describe("Dropdown Opening/Closing", () => {
        ...
        it("should call onOpenChange callback", async () => {
            ...
            render(
                <Select options={mockOptions} onOpenChange={onOpenChange} data-testid="select" />,
            );
    ...
    describe("Single Selection", () => {
        it("should select option on click", async () => {
            ...
            render(<Select options={mockOptions} onChange={onChange} data-testid="select" />);
    ...
    describe("Multiple Selection", () => {
        it("should allow multiple selections", async () => {
            ...
            const onChange = vi.fn();
            render(
                <Select options={mockOptions} multiple onChange={onChange} data-testid="select" />,
            );
    ...
    describe("Search Functionality", () => {
        ...
        it("should use custom filterOption function", async () => {
            const user = userEvent.setup();
            const filterOption = vi.fn((option, query) => option.value.includes(query));
    ...
    describe("Clear Functionality", () => {
        it("should show clear button when clearable and has value", () => {
            render(
                <Select options={mockOptions} clearable defaultValue="1" data-testid="select" />,
            );
            expect(screen.getByTestId("select-clear-button")).toBeInTheDocument();
        });

        it("should not show clear button when no value", () => {
            render(<Select options={mockOptions} clearable data-testid="select" />);
    ...
    describe("Option Groups", () => {
        it("should render option groups", async () => {
            const user = userEvent.setup();
            render(<Select optionGroups={mockOptionGroups} data-testid="select" />);
        ...
        it("should select options from groups", async () => {
            ...
            const onChange = vi.fn();
            render(
                <Select optionGroups={mockOptionGroups} onChange={onChange} data-testid="select" />,
            );
    ...
    describe("Loading State", () => {
        ...
        it("should show loading message in dropdown", async () => {
            ...
            await user.click(screen.getByTestId("select-control"));
            expect(screen.getByTestId("select-loading-message")).toHaveTextContent(
                "Loading data...",
            );
        });
    });
    ...
    describe("Custom Renderers", () => {
        it("should use custom renderOption", async () => {
            ...
            render(
                <Select options={mockOptions} renderOption={renderOption} data-testid="select" />,
            );
            await user.click(screen.getByTestId("select-control"));
        ...
        it("should use custom renderPlaceholder", () => {
            ...
            expect(screen.getByTestId("custom-placeholder")).toHaveTextContent(
                "Custom Placeholder",
            );
        });
    });
    ...
    describe("Focus and Blur Events", () => {
        it("should call onFocus callback", async () => {
            const user = userEvent.setup();
            const onFocus = vi.fn();
            render(<Select options={mockOptions} onFocus={onFocus} data-testid="select" />);
        ...
        it("should call onBlur callback", async () => {
            const user = userEvent.setup();
            const onBlur = vi.fn();
            render(<Select options={mockOptions} onBlur={onBlur} data-testid="select" />);
    ...
    describe("Accessibility", () => {
        ...
        it("should support aria-label", () => {
            render(
                <Select options={mockOptions} aria-label="Select an option" data-testid="select" />,
            );
        ...
        it("should have aria-multiselectable in multiple mode", async () => {
            const user = userEvent.setup();
            render(<Select options={mockOptions} multiple id="test" data-testid="select" />);
        ...
        it("should set aria-selected on selected options", async () => {
            const user = userEvent.setup();
            render(<Select options={mockOptions} defaultValue="1" data-testid="select" />);
    ...
    describe("Dropdown Positioning", () => {
        it("should apply correct dropdown alignment", async () => {
            const user = userEvent.setup();
            const {rerender} = render(
                <Select options={mockOptions} dropdownAlign="left" data-testid="select" />,
            );
            ...
            rerender(<Select options={mockOptions} dropdownAlign="right" data-testid="select" />);
    ...
    describe("Error State", () => {
        ...
        it("should apply error class when errorMessage is provided", () => {
            render(
                <Select options={mockOptions} errorMessage="Error occurred" data-testid="select" />,
            );
            expect(screen.getByTestId("select-control")).toHaveClass(/error/);
        });
    });
