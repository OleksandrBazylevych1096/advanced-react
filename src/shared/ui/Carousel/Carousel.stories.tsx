...
export const Default: Story = {
    render: () => (
        <Carousel>
            <div style={{...slideBaseStyles, background: "#ff6b6b"}}>Slide 1</div>
            <div style={{...slideBaseStyles, background: "#4ecdc4"}}>Slide 2</div>
            <div style={{...slideBaseStyles, background: "#45b7d1"}}>Slide 3</div>
            <div style={{...slideBaseStyles, background: "#f9ca24"}}>Slide 4</div>
            <div style={{...slideBaseStyles, background: "#95e1d3"}}>Slide 5</div>
        </Carousel>
    ),
};
