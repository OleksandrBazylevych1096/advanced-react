...
export const Modal = (props: ModalProps) => {
    ...
    const closeOnOverlayMouseDown = (e: MouseEvent<HTMLDivElement>) => {
    ...
    if (lazy && !isMounted) {
        return <ModalContext.Provider value={contextValue}>{triggers}</ModalContext.Provider>;
    }
        ...
        <ModalContext.Provider value={contextValue}>
            ...
            {isMounted && (
                <Portal>
                    ...
                    >
                        <div className={styles.overlay} onMouseDown={closeOnOverlayMouseDown}>
                            {contents}
                        </div>
                    </div>
                </Portal>
...
const ModalContent = (props: ModalContentProps) => {
    ...
    const stopContentClickPropagation = (e: MouseEvent<HTMLDivElement>) => {
        e.stopPropagation();
    };

    return (
        <div
            onClick={stopContentClickPropagation}
...
const ModalHeader = (props: ModalHeaderProps) => {
    ...
    return (
        <div className={cn(styles.header, className)} data-testid={testId}>
            ...
            <Button size="lg" theme="ghost" onClick={onClose} className={styles.closeButton}>
...
const ModalBody = (props: ModalBodyProps) => {
    ...
    return (
        <div className={cn(styles.body, className)} data-testid={testId}>
            {children}
        </div>
    );
};
...
const ModalFooter = (props: ModalFooterProps) => {
    ...
    return (
        <div className={cn(styles.footer, className)} data-testid={testId}>
            {children}
        </div>
    );
};
