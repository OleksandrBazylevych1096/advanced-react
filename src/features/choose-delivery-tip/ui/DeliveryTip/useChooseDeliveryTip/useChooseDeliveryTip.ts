...
} from "@/features/choose-delivery-tip/config/consts.ts";
...
import {selectChooseDeliveryTipAmount} from "../../../model/selectors/chooseDeliveryTipSelectors.ts";
import {chooseDeliveryTipActions} from "../../../model/slice/chooseDeliveryTipSlice.ts";

export const useChooseDeliveryTip = () => {
