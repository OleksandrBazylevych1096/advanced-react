...
export const saveShippingAddressSlice = createSlice({
    ...
    reducers: {
        ...
        initializeAddMode: (state, action: PayloadAction<{location?: LatLngTuple}>) => {
            state.mode = "add";
...
export const {actions: saveShippingAddressActions} = saveShippingAddressSlice;

export const {reducer: saveShippingAddressReducer} = saveShippingAddressSlice;
