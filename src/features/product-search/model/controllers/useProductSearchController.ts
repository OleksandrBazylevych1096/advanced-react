...
} from "@/features/product-search/config/constants";
import {
    selectProductSearchIsFocused,
    selectProductSearchQuery,
} from "@/features/product-search/model/selectors/productSearchSelectors";
import {productSearchActions} from "@/features/product-search/model/slice/productSearchSlice";
...
export const useProductSearchController = () => {
